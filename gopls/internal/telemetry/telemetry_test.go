...
func TestTelemetry(t *testing.T) {
	...
	WithOptions(
		...
		//
		// `gopls/bug
		// github.com/golang/tools/gopls/internal/util/bug.report:+35
		// github.com/golang/tools/gopls/internal/util/bug.Report:=68
		// github.com/golang/tools/gopls/internal/telemetry_test.TestTelemetry.func2:+4
		// github.com/golang/tools/gopls/internal/test/integration.(*Runner).Run.func1:+87
		// testing.tRunner:+150
		// runtime.goexit:+0`
		//
