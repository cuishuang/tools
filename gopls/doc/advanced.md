...
```sh
$ go install github.com/golang/tools/gopls@vX.Y.Z
```
...
go get -d github.com/golang/tools/gopls@master golang.org/x/tools@master

go install github.com/golang/tools/gopls
```
