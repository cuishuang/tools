...
```
$ go run github.com/golang/tools/gopls/internal/analysis/modernize/cmd/modernize@latest -test ./...
```
...
```
$ go run github.com/golang/tools/gopls/internal/analysis/gofix/cmd/gofix@latest -test -fix ./...
```
