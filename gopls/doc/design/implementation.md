...
[cache]: https://pkg.go.dev/github.com/golang/tools/gopls@master/internal/cache
[cmd]: https://pkg.go.dev/github.com/golang/tools/gopls@master/internal/cmd
[command]: https://pkg.go.dev/github.com/golang/tools/gopls@master/internal/protocol/command
[debug]: https://pkg.go.dev/github.com/golang/tools/gopls@master/internal/debug
[file]: https://pkg.go.dev/github.com/golang/tools/gopls@master/internal/file
[filecache]: https://pkg.go.dev/github.com/golang/tools/gopls@master/internal/filecache
...
[gopls]: https://pkg.go.dev/github.com/golang/tools/gopls@master
[jsonrpc2]: https://pkg.go.dev/golang.org/x/tools@master/internal/jsonrpc2
[lsprpc]: https://pkg.go.dev/github.com/golang/tools/gopls@master/internal/lsprpc
[memoize]: https://github.com/golang/tools/tree/master/internal/memoize
[metadata]: https://pkg.go.dev/github.com/golang/tools/gopls@master/internal/cache/metadata
[methodsets]: https://pkg.go.dev/github.com/golang/tools/gopls@master/internal/cache/methodsets
[mod]: https://pkg.go.dev/github.com/golang/tools/gopls@master/internal/mod
[parsego]: https://pkg.go.dev/github.com/golang/tools/gopls@master/internal/cache/parsego
[protocol]: https://pkg.go.dev/github.com/golang/tools/gopls@master/internal/protocol
[server]: https://pkg.go.dev/github.com/golang/tools/gopls@master/internal/server
[settings]: https://pkg.go.dev/github.com/golang/tools/gopls@master/internal/settings
[golang]: https://pkg.go.dev/github.com/golang/tools/gopls@master/internal/golang
[template]: https://pkg.go.dev/github.com/golang/tools/gopls@master/internal/template
[typerefs]: https://pkg.go.dev/github.com/golang/tools/gopls@master/internal/cache/typerefs
[work]: https://pkg.go.dev/github.com/golang/tools/gopls@master/internal/work
[x/tools]: https://github.com/golang/tools@master
[xrefs]: https://pkg.go.dev/github.com/golang/tools/gopls@master/internal/cache/xrefs
