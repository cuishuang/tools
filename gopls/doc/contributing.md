...
Most of the `gopls` logic is in the `github.com/golang/tools/gopls/internal`
...
```bash
$ gopls version
github.com/golang/tools/gopls master
    github.com/golang/tools/gopls@(devel)
```
...
both the `golang.org/x/tools` and `github.com/golang/tools/gopls` modules, as
described above.
